...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u"resources/arrow.png", QSize(), QIcon.Normal, QIcon.Off)
        self.arrowButton.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u"resources/rectangle.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"resources/ellipse.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cirButton.setIcon(icon3)
