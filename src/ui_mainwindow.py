...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.UndoTab, 1, 10, 1, 1)
        ...
        icon = QIcon()
        icon.addFile(u"resources/ellipsefinger.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cirButton.setIcon(icon)
        ...
        icon2 = QIcon()
        icon2.addFile(u"resources/rectanglefinger.png", QSize(), QIcon.Normal, QIcon.Off)
        self.rectButton.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u"resources/arrowfinger.png", QSize(), QIcon.Normal, QIcon.Off)
        self.arrowButton.setIcon(icon3)
        ...
        self.gridLayout_3.addWidget(self.scrollArea, 1, 12, 4, 13)
        ...
        self.gridLayout_3.addWidget(self.helpEdit, 1, 25, 4, 2)
        ...
        icon4 = QIcon()
        icon4.addFile(u"resources/panningicon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"resources/zoom icon.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.zoomButton.setIcon(icon5)
        ...
        self.gridLayout_3.addWidget(self.tabWidget, 1, 4, 4, 1)
