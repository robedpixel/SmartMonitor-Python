...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.scrollArea, 1, 12, 7, 13)
        ...
        self.gridLayout_3.addWidget(self.tabWidget, 1, 4, 7, 1)
        ...
        self.gridLayout_3.addWidget(self.helpEdit, 1, 25, 7, 2)
