...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.AreaTab.sizePolicy().hasHeightForWidth())
        self.AreaTab.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_3.addLayout(self.helpLayout, 1, 25, 4, 2)
