...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon6 = QIcon()
        icon6.addFile(u"resources/line-tool.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u"resources/rectangle.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u"resources/ellipse.png", QSize(), QIcon.Normal, QIcon.Off)
